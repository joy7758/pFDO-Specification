...
class Authentication2(BaseModel):
    model_config = ConfigDict(extra='forbid')
    key: str
class ExtendedValidateRequest(BaseModel):
    model_config = ConfigDict(extra='forbid')
    ...
    operationId: Literal['0.DOIP/Op.Validate'] = Field(..., description='operationId: the identifier of the operation to be performed.')
