...
class Attributes(BaseModel):
    input: str = Field(..., description='The text to be searched for.')
class ExtendedQueryFreeTextRequest(BaseModel):
    model_config = ConfigDict(extra='forbid')
    ...
    operationId: Literal['0.DOIP/Op.Extended-QueryFreeText'] = Field(..., description='operationId: the identifier of the operation to be performed.')
