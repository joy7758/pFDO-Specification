...
class Attributes(BaseModel):
    input: str = Field(..., description='Agent ID for which all published FDOs should be queried.')
class ExtendedQueryFeedRequest(BaseModel):
    model_config = ConfigDict(extra='forbid')
    ...
    operationId: Literal['Op.QueryFeed'] = Field(..., description='operationId: the identifier of the operation to be performed.')
