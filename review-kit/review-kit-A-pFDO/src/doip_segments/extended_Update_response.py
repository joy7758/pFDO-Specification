...
class Attributes(BaseModel):
    record: Dict[str, Any] = Field(..., description='record: the JSON object containing all type-value-pairs that were used to override the previous values in the PID record.')
...
class ExtendedUpdateResponse(BaseModel):
    ...
    attributes: Optional[Attributes] = Field(None, description='attributes: JSON object that returns the type-value pairs in the PID record.')
