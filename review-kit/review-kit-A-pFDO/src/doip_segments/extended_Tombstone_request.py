...
class Attributes(BaseModel):
    message: str = Field(..., description='message: A human readable message that explains the reason whe the FDO is tombstoned.')
...
class ExtendedTombstoneRequest(BaseModel):
    ...
    operationId: Literal['0.DOIP/Op.Tombstone'] = Field(..., description='operationId: the identifier of the operation to be performed.')
    attributes: Attributes = Field(..., description='attributes: mandatory JSON object to specify the message')
