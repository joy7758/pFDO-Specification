...
class Attributes(BaseModel):
    record: Dict[str, Any] = Field(..., description='if record is specified as true in the request, returns all FDO attributes from the FDO record')
...
class ExtendedRetrieveResponse(BaseModel):
    ...
    output: Optional[DoipDoSerialization] = Field(None, description='serialization of a digital object')